...
class CharacterListAdapter : ListAdapter<SimpleCharacter, CharacterListAdapter.CharacterViewHolder>(DIFF_CALLBACK) {
    ...
    class CharacterViewHolder(private val binding: ItemCharacterCardBinding): RecyclerView.ViewHolder(binding.root){
